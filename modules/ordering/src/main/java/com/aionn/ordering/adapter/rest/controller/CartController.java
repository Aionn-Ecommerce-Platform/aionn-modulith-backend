...
public class CartController {
        ...
        public ResponseEntity<ApiResponse<CartResponse>> addItem(
                ...
                CartResponse response = dtoMapper.toResponse(
                                addItemInputPort.execute(dtoMapper.toAddItemCommand(userId, request)));
        ...
        public ResponseEntity<ApiResponse<CartResponse>> updateItem(
                ...
                CartResponse response = dtoMapper.toResponse(
                                updateItemQtyInputPort
                                                .execute(dtoMapper.toUpdateItemQtyCommand(userId, skuId, request)));
        ...
        public ResponseEntity<ApiResponse<CartResponse>> removeItem(
                        ...
                        @PathVariable String skuId) {
                CartResponse response = dtoMapper.toResponse(
                                removeItemInputPort.execute(dtoMapper.toRemoveItemCommand(userId, skuId)));
        ...
        public ResponseEntity<ApiResponse<CartResponse>> clearCart(@CurrentUserId String userId) {
                CartResponse response = dtoMapper.toResponse(
                                clearCartInputPort.execute(dtoMapper.toClearCartCommand(userId, "user-cleared")));
        ...
        public ResponseEntity<ApiResponse<CartResponse>> applyVoucher(
                ...
                CartResponse response = dtoMapper.toResponse(
                                applyVoucherInputPort.execute(dtoMapper.toApplyVoucherCommand(userId, request)));
        ...
        public ResponseEntity<ApiResponse<CartResponse>> removeVoucher(@CurrentUserId String userId) {
                CartResponse response = dtoMapper.toResponse(
                                removeVoucherInputPort.execute(dtoMapper.toRemoveVoucherCommand(userId)));
