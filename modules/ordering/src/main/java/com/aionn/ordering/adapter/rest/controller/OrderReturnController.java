...
public class OrderReturnController {
        ...
        public ResponseEntity<ApiResponse<OrderReturnResponse>> request(
                ...
                OrderReturnResponse response = dtoMapper.toResponse(
                                requestReturnInputPort
                                                .execute(dtoMapper.toRequestReturnCommand(orderId, userId, request)));
        ...
        public ResponseEntity<ApiResponse<OrderReturnResponse>> approve(
                ...
                OrderReturnResponse response = dtoMapper.toResponse(
                                approveReturnInputPort
                                                .execute(dtoMapper.toApproveReturnCommand(returnId, ownerId, request)));
        ...
        public ResponseEntity<ApiResponse<OrderReturnResponse>> reject(
                ...
                OrderReturnResponse response = dtoMapper.toResponse(
                                rejectReturnInputPort
                                                .execute(dtoMapper.toRejectReturnCommand(returnId, ownerId, request)));
        ...
        public ResponseEntity<ApiResponse<OrderReturnResponse>> confirmReceived(
                ...
                OrderReturnResponse response = dtoMapper.toResponse(confirmItemReceivedInputPort.execute(
                                new ConfirmItemReceivedCommand(returnId, ownerId, request.itemCondition())));
