...
public class OrderController {
        ...
        public ResponseEntity<ApiResponse<OrderResponse>> confirmPreparation(
                ...
                OrderResponse response = dtoMapper.toResponse(
                                confirmPreparationInputPort
                                                .execute(dtoMapper.toConfirmPreparationCommand(orderId, ownerId)));
        ...
        public ResponseEntity<ApiResponse<OrderResponse>> cancel(
                ...
                OrderResponse response = dtoMapper.toResponse(
                                cancelOrderInputPort.execute(dtoMapper.toCancelOrderCommand(orderId, userId, request)));
        ...
        public ResponseEntity<ApiResponse<OrderResponse>> reject(
                ...
                OrderResponse response = dtoMapper.toResponse(
                                rejectOrderInputPort
                                                .execute(dtoMapper.toRejectOrderCommand(orderId, ownerId, request)));
        ...
        public ResponseEntity<ApiResponse<OrderResponse>> changeShippingInfo(
                ...
                OrderResponse response = dtoMapper.toResponse(
                                changeShippingInfoInputPort.execute(
                                                dtoMapper.toChangeShippingInfoCommand(orderId, userId, request)));
        ...
        public ResponseEntity<ApiResponse<OrderResponse>> ship(
                ...
                OrderResponse response = dtoMapper.toResponse(
                                confirmShippedInputPort.execute(dtoMapper.toConfirmShippedCommand(orderId, request)));
        ...
        public ResponseEntity<ApiResponse<OrderResponse>> complete(@PathVariable String orderId) {
                OrderResponse response = dtoMapper.toResponse(
                                confirmDeliveredInputPort.execute(dtoMapper.toConfirmDeliveredCommand(orderId)));
