...
class InMemoryFacetProductSearchIndexTest {
        ...
        private static ProductSearchCriteria criteria(List<String> categoryIds, List<String> brandIds,
                        BigDecimal min, BigDecimal max, Map<String, List<String>> attrs,
                        ProductSearchCriteria.Sort sort) {
        ...
        void setUp() {
                ...
                index.index(doc("p1", "b1", List.of("c1"), new BigDecimal("100"), Map.of("color", "red"), 5, 4.0,
                                "PUBLISHED"));
                index.index(doc("p2", "b2", List.of("c1", "c2"), new BigDecimal("200"), Map.of("color", "blue"), 20,
                                5.0,
                                "PUBLISHED"));
                index.index(doc("p3", "b1", List.of("c3"), new BigDecimal("50"), Map.of("color", "red"), 1, 3.0,
                                "HIDDEN"));
        }
        ...
        void searchExcludesNonPublishedByDefault() {
                Optional<ProductSearchIndex.SearchHits> hits = index.search(
                                criteria(List.of(), List.of(), null, null, Map.of(),
        ...
        void searchFiltersByBrandAndComputesFacets() {
                Optional<ProductSearchIndex.SearchHits> hits = index.search(
                                criteria(List.of(), List.of("b1"), null, null, Map.of(),
                                                ProductSearchCriteria.Sort.RELEVANCE));
        ...
        void searchSortsByPriceAscending() {
                Optional<ProductSearchIndex.SearchHits> hits = index.search(
                                criteria(List.of(), List.of(), null, null, Map.of(),
                                                ProductSearchCriteria.Sort.PRICE_ASC));
        ...
        void searchSortsByBestSeller() {
                Optional<ProductSearchIndex.SearchHits> hits = index.search(
                                criteria(List.of(), List.of(), null, null, Map.of(),
                                                ProductSearchCriteria.Sort.BEST_SELLER));
        ...
        void searchByTextMatchesName() {
                ProductSearchCriteria textCriteria = new ProductSearchCriteria("Widget p2", null, null,
                                List.of(), List.of(), null, null, Map.of(), ProductSearchCriteria.Sort.RELEVANCE, 0,
                                20);
        ...
        void countMatchesRespectsPagination() {
                ProductSearchCriteria firstPageSizeOne = new ProductSearchCriteria(null, null, null, List.of(),
                                List.of(),
        ...
        void searchIgnoresAttributeFilterWithEmptyValues() {
                ...
                Optional<ProductSearchIndex.SearchHits> hits = index.search(
                                criteria(List.of(), List.of(), null, null, attrs,
                                                ProductSearchCriteria.Sort.RELEVANCE));
