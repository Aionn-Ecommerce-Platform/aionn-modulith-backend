...
public class ActivateMerchantUseCase implements ActivateMerchantInputPort {
    ...
    @Override
    @Transactional
    public MerchantResult execute(ActivateMerchantCommand command) {
        Merchant merchant = merchantService.activate(command);
