...
public class ListMyFlashSaleRegistrationsUseCase implements ListMyFlashSaleRegistrationsInputPort {
    ...
    public List<FlashSaleRegistrationResult> execute(String ownerId, FlashSaleRegistrationStatus status, int limit) {
        return flashSaleResultMapper.toResults(flashSaleService.listByMerchant(ownerId, status, limit));
    }
}
