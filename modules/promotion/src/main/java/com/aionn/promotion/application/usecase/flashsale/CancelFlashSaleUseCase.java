...
public class CancelFlashSaleUseCase implements CancelFlashSaleInputPort {
    ...
    @Override
    @Transactional
    public FlashSaleRegistrationResult execute(FlashSaleCommands.CancelFlashSale command) {
        return flashSaleResultMapper.toResult(flashSaleService.cancel(command));
    }
}
