...
public class RejectFlashSaleUseCase implements RejectFlashSaleInputPort {
    ...
    @Override
    @Transactional
    public FlashSaleRegistrationResult execute(FlashSaleCommands.RejectFlashSale command) {
        return flashSaleResultMapper.toResult(flashSaleService.reject(command));
    }
}
