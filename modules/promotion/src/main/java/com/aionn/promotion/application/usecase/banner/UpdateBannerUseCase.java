...
public class UpdateBannerUseCase implements UpdateBannerInputPort {
    ...
    @Override
    @Transactional
    public PromotionBannerResult execute(BannerCommands.UpdateBanner command) {
        return promotionBannerResultMapper.toResult(promotionBannerService.update(command));
    }
}
