...
public class ClaimVoucherUseCase implements ClaimVoucherInputPort {

    private final VoucherService voucherService;

    @Override
    @Transactional
    public UserVoucherResult execute(VoucherCommands.ClaimVoucher command) {
        return voucherService.claim(command);
    }
}
