...
public class ConfigureCampaignConditionUseCase implements ConfigureCampaignConditionInputPort {
    ...
    @Override
    @Transactional
    public CampaignResult execute(CampaignCommands.ConfigureCondition command) {
        return campaignResultMapper.toResult(promotionCampaignService.configureCondition(command));
    }
}
