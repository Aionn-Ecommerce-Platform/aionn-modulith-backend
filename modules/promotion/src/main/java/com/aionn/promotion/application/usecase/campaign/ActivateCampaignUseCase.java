...
public class ActivateCampaignUseCase implements ActivateCampaignInputPort {
    ...
    @Override
    @Transactional
    public CampaignResult execute(CampaignCommands.ActivateCampaign command) {
        return campaignResultMapper.toResult(promotionCampaignService.activate(command));
    }
}
