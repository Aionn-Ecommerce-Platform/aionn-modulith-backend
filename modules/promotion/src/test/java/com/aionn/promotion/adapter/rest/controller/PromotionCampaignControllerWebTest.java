...
import com.aionn.promotion.adapter.rest.mapper.campaign.PromotionCampaignDtoMapperImpl;
...
class PromotionCampaignControllerWebTest {
        ...
        @Mock
        private CreateCampaignInputPort createCampaignInputPort;
        @Mock
        private ActivateCampaignInputPort activateCampaignInputPort;
        @Mock
        private EndCampaignInputPort endCampaignInputPort;
        @Mock
        private CancelCampaignInputPort cancelCampaignInputPort;
        @Mock
        private ConfigureCampaignConditionInputPort configureCampaignConditionInputPort;
        @Mock
        private IssueCampaignVoucherInputPort issueCampaignVoucherInputPort;
        @Mock
        private GetCampaignInputPort getCampaignInputPort;
        @Mock
        private ListCampaignsByStatusInputPort listCampaignsByStatusInputPort;
        @Mock
        private ListCampaignVouchersInputPort listCampaignVouchersInputPort;

        private MockMvc mockMvc;

        @BeforeEach
        void setUp() {
                PromotionCampaignController controller = new PromotionCampaignController(
                                createCampaignInputPort, activateCampaignInputPort, endCampaignInputPort,
                                cancelCampaignInputPort, configureCampaignConditionInputPort,
                                issueCampaignVoucherInputPort, getCampaignInputPort,
                                listCampaignsByStatusInputPort, listCampaignVouchersInputPort,
                                new PromotionCampaignDtoMapperImpl(), new VoucherDtoMapperImpl());
        ...
        void createReturnsCreatedCampaign() throws Exception {
                when(createCampaignInputPort.execute(any(CampaignCommands.CreateCampaign.class)))
                                .thenReturn(sample("camp-1", "SCHEDULED"));
                ...
                verify(createCampaignInputPort).execute(any(CampaignCommands.CreateCampaign.class));
        }
        ...
        @Test
        void activateInvokesInputPort() throws Exception {
                when(activateCampaignInputPort.execute(any(CampaignCommands.ActivateCampaign.class)))
        ...
        @Test
        void endInvokesInputPort() throws Exception {
                when(endCampaignInputPort.execute(any(CampaignCommands.EndCampaign.class)))
                                .thenReturn(sample("camp-1", "ENDED"));

                mockMvc.perform(post("/api/v1/promotions/campaigns/camp-1/end"))
                                .andExpect(status().isOk())
                                .andExpect(jsonPath("$.data.status").value("ENDED"));
        }

        @Test
        void cancelInvokesInputPortWithReason() throws Exception {
                when(cancelCampaignInputPort.execute(any(CampaignCommands.CancelCampaign.class)))
        ...
        void configureConditionsUpdatesCampaign() throws Exception {
                when(configureCampaignConditionInputPort.execute(any(CampaignCommands.ConfigureCondition.class)))
                                .thenReturn(sample("camp-1", "SCHEDULED"));
        ...
        @Test
        void issueVoucherInvokesInputPort() throws Exception {
                when(issueCampaignVoucherInputPort.execute(any(CampaignCommands.IssueVoucher.class)))
        ...
        void getReturnsCampaign() throws Exception {
                when(getCampaignInputPort.execute("camp-1")).thenReturn(sample("camp-1", "SCHEDULED"));
        ...
        void listByStatusReturnsCampaigns() throws Exception {
                when(listCampaignsByStatusInputPort.execute("RUNNING", 50))
        ...
        @Test
        void listVouchersReturnsCampaignVouchers() throws Exception {
                when(listCampaignVouchersInputPort.execute("camp-1", 50))
                                .thenReturn(List.of(voucherSample("V-1")));

                mockMvc.perform(get("/api/v1/promotions/campaigns/camp-1/vouchers"))
                                .andExpect(status().isOk())
