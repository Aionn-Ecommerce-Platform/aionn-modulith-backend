...
public interface ShippingGatewayPort {
        ...
        // Snapshot of the recipient address used by Shipping. Mirrors the structure
        // of the Ordering domain ShippingAddress but lives in shared-kernel so it can
        // be referenced by both Ordering and Shipping modules without leaking domain
        // types.
